    ...
    */
    ...
    public R save(@RequestBody FeiyongEntity feiyong, HttpServletRequest request){
        ...
        Wrapper<FeiyongEntity> queryWrapper = new EntityWrapper<FeiyongEntity>()
            ...
            .eq("renyuan_jieguo", feiyong.getRenyuanJieguo())
            ;
...
//                            feiyongEntity.setFeiyongName(data.get(0));                    //标题 要改的
//                            feiyongEntity.setFeiyongTypes(Integer.valueOf(data.get(0)));   //费用类型 要改的
//                            feiyongEntity.setFeiyongMoney(data.get(0));                    //涉及金额 要改的
//                            feiyongEntity.setYonghuId(Integer.valueOf(data.get(0)));   //业主 要改的
//                            feiyongEntity.setRenyuanJieguo(data.get(0));                    //收费结果 要改的
//                            feiyongEntity.setFeiyongContent("");//详情和图片
