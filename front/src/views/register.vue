<template>
    <div style="backgroundImage: url('/xiaoquwuyezhinengka/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">小区物业智能卡管理注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="业主姓名" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuName" autocomplete="off" placeholder="业主姓名"  />
                        </el-form-item>
